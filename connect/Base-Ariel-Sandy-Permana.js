...
module.exports = arielspkece = async (arielspkece, m, chatUpdate, store) => {
try {
...
arielspkece.sendText(m.chat, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+m.chat].pesan = mesg }).catch(_ => _)
...
await arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (budy.toLowerCase() == jawaban) {
await arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, creator, m)
...
if (room.x !== room.o) await arielspkece.sendText(room.x, str, m, { mentions: parseMention(str) } )
await arielspkece.sendText(room.o, str, m, { mentions: parseMention(str) } )
if (isTie || isWin) {
...
arielspkece.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
arielspkece.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
await arielspkece.sendButtonText(m.chat, buttons, `Mode Group`, creator, m)
}
}
break
case 'editinfo': {
...
await arielspkece.sendButtonText(m.chat, buttons, `Mode Edit Info`, creator, m)
}
}
break
case 'antilink': {
...
await arielspkece.sendButtonText(m.chat, buttons, `Mode Antilink`, creator, m)
}
}
break
case 'mute': {
...
await arielspkece.sendButtonText(m.chat, buttons, `Mute Bot`, creator, m)
}
}
break
...
if (this.game) {
delete this.game
arielspkece.sendText(m.chat, `Berhasil delete session TicTacToe`, m)
} else if (!this.game) {
...
id: 'family100'+m.chat,
pesan: await arielspkece.sendText(m.chat, hasil, m),
...random,
...
arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, arielspkece.user.name, m)
delete tebaklagu[m.sender.split('@')[0]]
}
...
let result = anu[Math.floor(Math.random() * anu.length)]
arielspkece.sendImage(m.chat, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
})
await sleep(60000)
if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Jawaban: " + result.jawaban)
arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, arielspkece.user.name, m)
delete tebakgambar[m.sender.split('@')[0]]
}
} else if (args[0] === 'kata') {
...
console.log("Jawaban: " + result.jawaban)
arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, arielspkece.user.name, m)
delete tebakkata[m.sender.split('@')[0]]
}
...
console.log("Jawaban: " + result.jawaban)
arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, arielspkece.user.name, m)
delete tebakkalimat[m.sender.split('@')[0]]
}
...
console.log("Jawaban: " + result.jawaban)
arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, arielspkece.user.name, m)
delete tebaklirik[m.sender.split('@')[0]]
}
...
console.log("Jawaban: " + result.jawaban)
arielspkece.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, arielspkece.user.name, m)
delete caklontong[m.sender.split('@')[0]]
delete caklontong_desk[m.sender.split('@')[0]]
}
}
...
arielspkece.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
this.suit[id] = {
chat: await arielspkece.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) arielspkece.sendText(m.chat, `_Waktu suit habis_`, m)
delete this.suit[id]
...
arielspkece.sendMessage(m.chat, {image:{url:buffer}, caption:"Done!"}, {quoted:m})
break
case 'arielpetir':{
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu3)
    arielspkece.sendMessage(m.chat, { image: { url : anu3 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu4)
    arielspkece.sendMessage(m.chat, { image: { url : anu4 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu6)
    arielspkece.sendMessage(m.chat, { image: { url : anu6 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu7)
    arielspkece.sendMessage(m.chat, { image: { url : anu7 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu9)
    arielspkece.sendMessage(m.chat, { image: { url : anu9 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu10)
    arielspkece.sendMessage(m.chat, { image: { url : anu10 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu12)
    arielspkece.sendMessage(m.chat, { image: { url : anu12 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu13)
    arielspkece.sendMessage(m.chat, { image: { url : anu13 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu15)
    arielspkece.sendMessage(m.chat, { image: { url : anu15 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu16)
    arielspkece.sendMessage(m.chat, { image: { url : anu16 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
if (args.length < 1) return m.reply(`*Example* : ${prefix + command} ${global.botname}`)
    const { textpro } = require('./scrape/textpro') 
     ...
     console.log(anu18)
    arielspkece.sendMessage(m.chat, { image: { url : anu18 }, caption: `${global.botname}`}, { quoted: ftroli } )
...
.on('error', () => m.reply('error'))
.on('exit', () => {
arielspkece.sendMessage(m.chat, { image: fs.readFileSync('./connect/nulis/buku/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
})
}
break
case 'foliokiri':{
...
m.reply(mess.wait)
                ...
                .on('error', () => m.reply('error'))
                .on('exit', () => {
                arielspkece.sendMessage(m.chat, { image: fs.readFileSync('./connect/nulis/buku/folio/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
...
m.reply(mess.wait)
                ...
                .on('error', () => m.reply('error'))
                .on('exit', () => {
                arielspkece.sendMessage(m.chat, { image: fs.readFileSync('./connect/nulis/buku/folio/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
break
case 'emojimix': {
		...
		for (let res of anu.results) {
		    let encmedia = await arielspkece.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
...
let encmedia = await arielspkece.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await arielspkece.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
let FaTiH = await arielspkece.sendImageAsSticker(m.chat, smeme, m, { packname: global.packname, author: global.author })
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await arielspkece.sendImageAsSticker(m.chat, media, m, { packname: teks1, author: teks2 })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await arielspkece.sendVideoAsSticker(m.chat, media, m, { packname: teks1, author: teks2 })
await fs.unlinkSync(encmedia)
} else {
throw `Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`
}
...
arielspkece.send5ButImg(yoi, txt, creator, image, btn)
}
...
let txt = `「 Broadcast Bot 」\n\n${text}`
arielspkece.send5ButImg(i, txt, creator, image, btn)
}
...
🔗 Url : ${anu.url}`,
                    footer: arielspkece.user.name,
                    buttons: buttons,
                    headerType: 4
                }
                arielspkece.sendMessage(m.chat, buttonMessage, { quoted: ftroli })
            }
            break
case 'menu2': {
...
_Mengirim file..._`
m.reply(result4)
arielspkece.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m }) 
break
case 'getcase':
if (!isCreator) throw mess.owner
const getCase = (cases) => {
return "case"+`'${cases}'`+fs.readFileSync("connect/Base-Ariel-Sandy-Permana.js").toString().split('case \''+cases+'\'')[1].split("break")[0]+"break"
}
m.reply(`${getCase(q)}`)
break
